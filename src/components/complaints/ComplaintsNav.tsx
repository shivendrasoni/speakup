        ...
        <div className="flex items-center justify-between h-16">
          <nav className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="hidden sm:inline">{TRANSLATIONS[language].successStories}</span>
            </Button>
            <Button 
              variant="ghost" 
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden sm:inline">{TRANSLATIONS[language].resources}</span>
            </Button>
            <Button 
              variant="ghost" 
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden sm:inline">{TRANSLATIONS[language].peerSupport}</span>
            </Button>
            <Button 
              variant="ghost" 
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden sm:inline">{TRANSLATIONS[language].liveQA}</span>
            </Button>
            <Button 
              variant="ghost" 
              className="flex items-center gap-2"
            ...
            >
              ...
              <span className="hidden sm:inline">{TRANSLATIONS[language].aiHelp}</span>
            </Button>
          </nav>
